...
export default function FrontLayout({ children, innercol
    ...
    return (
        ...
        <Toaster position="bottom-center" reverseOrder={false} />
            ...
            <a href="tel:+917303192721" className='fixed right-6 md:bottom-28 tbottom-24 z-10 w-14 h-14 flex items-center justify-center bg-[#013088] rounded-full p-2.5 cursor-pointer'>
